...
int Eckenstein_suchen(int Color1, int Color2, int Color3 )
{
    ...
    if (Color_eck== 100*color_data[3][8]+10*color_data[0][0]+color_data[4][8])   //1304
    ...
    //Zweite Schichte
    if (Color_eck== 100*color_data[2][0]+10*color_data[1][6]+color_data[4][0])   //3214
        eckPos=1000*3+100*2+10*1+4;
    if (Color_eck== 100*color_data[1][6]+10*color_data[4][0]+color_data[2][0])   //3142
        eckPos=1000*3+100*1+10*4+2;
    if (Color_eck== 100*color_data[4][0]+10*color_data[2][0]+color_data[1][6])   //3421
        eckPos=1000*3+100*4+10*2+1;
    ...
    if (Color_eck== 100*color_data[2][6]+10*color_data[4][2]+color_data[3][0])   //3243
        eckPos=1000*3+100*2+10*4+3;
    if (Color_eck== 100*color_data[4][2]+10*color_data[3][0]+color_data[2][6])   //3432
        eckPos=1000*3+100*4+10*3+2;
    if (Color_eck== 100*color_data[3][0]+10*color_data[2][6]+color_data[4][2])   //3324
        eckPos=1000*3+100*3+10*2+4;
